...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(dev.gentleartstudio.com www.dev.gentleartstudio.com);
...
From: bjj@gentleartstudio.com
Subject: Gentle Art Studio

Thank you for your emamil. We'll get back to you as soon as possible. 
